...
export const mockAliceContact: Contact = {
  pubKey: alicePKI,
  createdAt: new Date(),
...
export const mockBobContact: Contact = {
  pubKey: bobPKI,
  createdAt: new Date(),
  fullName: 'Bob Smith',
...
const bobSuccessfullyValidatedAlicesTotp = bobClient.ValidateTotpForContact(
  mockAliceContact, // Using Alice's contact since she generated the TOTP
  aliceTotpForBob,
  mockBobContact.paymail,
  TOTP_PERIOD,
  TOTP_DIGITS
);
console.log('Is Bob valid for Alice?', bobSuccessfullyValidatedAlicesTotp);
...
const aliceSuccessfullyValidatedBobsTotp = aliceClient.ValidateTotpForContact(
  mockBobContact, // Using Bob's contact since he generated the TOTP
  bobTotpForAlice,
  mockAliceContact.paymail,
  TOTP_PERIOD,
  TOTP_DIGITS
);
console.log('Is Alice valid for Bob?', aliceSuccessfullyValidatedBobsTotp);

// Final verification check (both should be valid for each other in this happy path example)
const isFullyVerified = bobSuccessfullyValidatedAlicesTotp && aliceSuccessfullyValidatedBobsTotp;
console.log('\n=== Final Verification ===');

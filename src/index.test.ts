...
const testAddress = "1CfaQw9udYNPccssFJFZ94DN8MqNZm9nGt"
const testAddress2 = "1PnRDRF517hhrFJ5VvR7QGcpQhc7qRshFA"
...
const xpubJSON = `{"data":{"xpub":{"id":"0092de4d2aafa59a71a1f90342c138e1c4f19cd1b10e2d17422b34a1d06733e0"}}}`
const testTxId = "041479f86c475603fd510431cf702bc8c9849a9c350390eb86b467d82a13cc24"
...
describe('GetTransaction', () => {
  const HttpUrl = "/transaction?id=041479f86c475603fd510431cf702bc8c9849a9c350390eb86b467d82a13cc24";
  test('result', async () => {
    // @ts-ignore
    ...
    await runTests(testClients, async (buxClient: TransportService) => {
      const transaction = await buxClient.GetTransaction(testTxId);
